...
>
  ...
  >
    ...
    >
      Please RSVP by September 16th, 2026
    </h2>
  </div>
</div>
      <>
...
>
  ...
  {isEditing ? (
    // Replace the entire label/input pair block with this:
<div style={{ display: 'flex', gap: '0.5rem' }}>
  <div
    onClick={() => setFormState(prev => ({ ...prev, usernameattending: true }))}
    style={{
      padding: '0.4rem 1.2rem',
      borderRadius: '30px',
      cursor: 'pointer',
      border: '1px solid rgba(255,255,255,0.3)',
      background: formState.usernameattending === true || formState.usernameattending === 'true'
        ? 'rgba(0, 180, 0, 0.6)' 
        : 'rgba(255,255,255,0.1)',
      color: 'white',
      boxShadow: formState.usernameattending === true || formState.usernameattending === 'true'
  ...
  <div
    onClick={() => setFormState(prev => ({ ...prev, usernameattending: false }))}
    style={{
      padding: '0.4rem 1.2rem',
      borderRadius: '30px',
      cursor: 'pointer',
      border: '1px solid rgba(255,255,255,0.3)',
      background: formState.usernameattending === false || formState.usernameattending === 'false'
        ? 'rgba(180, 0, 0, 0.6)' 
        : 'rgba(255,255,255,0.1)',
      color: 'white',
      boxShadow: formState.usernameattending === false || formState.usernameattending === 'false'
  ...
  style={{
    ...
    background: formState.usernameattending === true || formState.usernameattending === 'true'
      ? 'rgba(0, 180, 0, 0.6)'
      : formState.usernameattending === false || formState.usernameattending === 'false'
      ? 'rgba(180, 0, 0, 0.6)'
      : 'rgba(255, 0, 0, 0.3)',
    color: 'white',
    boxShadow: formState.usernameattending === true || formState.usernameattending === 'true'
...
>
  <h2 style={{ margin: 0 }}>
    {formState.usernameattending === true || formState.usernameattending === 'true' ? 'Attending' :
     formState.usernameattending === false || formState.usernameattending === 'false' ? 'Not Attending' :
...
{formState.usernameguest && (
  <div style={{
    ...
    {isEditing ? (
      <div style={{ display: 'flex', gap: '0.5rem' }}>
        <div
          onClick={() => setFormState(prev => ({ ...prev, usernameguestattending: true }))}
          style={{
            padding: '0.4rem 1.2rem',
            borderRadius: '30px',
            cursor: 'pointer',
            border: '1px solid rgba(255,255,255,0.3)',
            background: formState.usernameguestattending === true || formState.usernameguestattending === 'true'
              ? 'rgba(0, 180, 0, 0.6)'
              : 'rgba(255,255,255,0.1)',
            color: 'white',
            boxShadow: formState.usernameguestattending === true || formState.usernameguestattending === 'true'
              ? '0 0 8px rgba(0,255,0,0.4)'
              : 'none',
            transition: 'all 0.2s ease',
          }}
        ...
        <div
          onClick={() => setFormState(prev => ({ ...prev, usernameguestattending: false }))}
          style={{
            padding: '0.4rem 1.2rem',
            borderRadius: '30px',
            cursor: 'pointer',
            border: '1px solid rgba(255,255,255,0.3)',
            background: formState.usernameguestattending === false || formState.usernameguestattending === 'false'
              ? 'rgba(180, 0, 0, 0.6)'
              : 'rgba(255,255,255,0.1)',
            color: 'white',
            boxShadow: formState.usernameguestattending === false || formState.usernameguestattending === 'false'
              ? '0 0 8px rgba(255,0,0,0.4)'
              : 'none',
            transition: 'all 0.2s ease',
          }}
      ...
      <div
        style={{
          ...
          background: formState.usernameguestattending === true || formState.usernameguestattending === 'true'
            ? 'rgba(0, 180, 0, 0.6)'
            : formState.usernameguestattending === false || formState.usernameguestattending === 'false'
            ? 'rgba(180, 0, 0, 0.6)'
            : 'rgba(255, 0, 0, 0.3)',
          color: 'white',
          boxShadow: formState.usernameguestattending === true || formState.usernameguestattending === 'true'
      ...
      >
        <h2 style={{ margin: 0 }}>
          {formState.usernameguestattending === true || formState.usernameguestattending === 'true' ? 'Attending' :
           formState.usernameguestattending === false || formState.usernameguestattending === 'false' ? 'Not Attending' :
           'Please note attendance'}
        </h2>
      </div>
    )}
...
`, 
 ...
 <div style={{
  ...
  {isEditing ? (
    <div style={{ display: 'flex', gap: '0.5rem' }}>
      <div
        onClick={() => setFormState(prev => ({ ...prev, usernameattendingrehearsal: true }))}
        style={{
          padding: '0.4rem 1.2rem',
          borderRadius: '30px',
          cursor: 'pointer',
          border: '1px solid rgba(255,255,255,0.3)',
          background: formState.usernameattendingrehearsal === true || formState.usernameattendingrehearsal === 'true'
            ? 'rgba(0, 180, 0, 0.6)'
            : 'rgba(255,255,255,0.1)',
          color: 'white',
          boxShadow: formState.usernameattendingrehearsal === true || formState.usernameattendingrehearsal === 'true'
            ? '0 0 8px rgba(0,255,0,0.4)'
            : 'none',
          transition: 'all 0.2s ease',
        }}
      ...
      <div
        onClick={() => setFormState(prev => ({ ...prev, usernameattendingrehearsal: false }))}
        style={{
          padding: '0.4rem 1.2rem',
          borderRadius: '30px',
          cursor: 'pointer',
          border: '1px solid rgba(255,255,255,0.3)',
          background: formState.usernameattendingrehearsal === false || formState.usernameattendingrehearsal === 'false'
            ? 'rgba(180, 0, 0, 0.6)'
            : 'rgba(255,255,255,0.1)',
          color: 'white',
          boxShadow: formState.usernameattendingrehearsal === false || formState.usernameattendingrehearsal === 'false'
            ? '0 0 8px rgba(255,0,0,0.4)'
            : 'none',
          transition: 'all 0.2s ease',
        }}
    ...
    <div
      style={{
        ...
        background: formState.usernameattendingrehearsal === true || formState.usernameattendingrehearsal === 'true'
          ? 'rgba(0, 180, 0, 0.6)'
          : formState.usernameattendingrehearsal === false || formState.usernameattendingrehearsal === 'false'
          ? 'rgba(180, 0, 0, 0.6)'
          : 'rgba(255, 0, 0, 0.3)',
        color: 'white',
        boxShadow: formState.usernameattendingrehearsal === true || formState.usernameattendingrehearsal === 'true'
    ...
    >
      <h2 style={{ margin: 0 }}>
        {formState.usernameattendingrehearsal === true || formState.usernameattendingrehearsal === 'true' ? 'Attending' :
         formState.usernameattendingrehearsal === false || formState.usernameattendingrehearsal === 'false' ? 'Not Attending' :
         'Please note attendance'}
      </h2>
    </div>
  )}
...
{formState.source === 'WeddingParty' && formState.usernameguest && (
 <div style={{
  ...
  {isEditing ? (
    <div style={{ display: 'flex', gap: '0.5rem' }}>
      <div
        onClick={() => setFormState(prev => ({ ...prev, usernameguestattendingrehearsal: true }))}
        style={{
          padding: '0.4rem 1.2rem',
          borderRadius: '30px',
          cursor: 'pointer',
          border: '1px solid rgba(255,255,255,0.3)',
          background: formState.usernameguestattendingrehearsal === true || formState.usernameguestattendingrehearsal === 'true'
            ? 'rgba(0, 180, 0, 0.6)'
            : 'rgba(255,255,255,0.1)',
          color: 'white',
          boxShadow: formState.usernameguestattendingrehearsal === true || formState.usernameguestattendingrehearsal === 'true'
            ? '0 0 8px rgba(0,255,0,0.4)'
            : 'none',
          transition: 'all 0.2s ease',
        }}
      ...
      <div
        onClick={() => setFormState(prev => ({ ...prev, usernameguestattendingrehearsal: false }))}
        style={{
          padding: '0.4rem 1.2rem',
          borderRadius: '30px',
          cursor: 'pointer',
          border: '1px solid rgba(255,255,255,0.3)',
          background: formState.usernameguestattendingrehearsal === false || formState.usernameguestattendingrehearsal === 'false'
            ? 'rgba(180, 0, 0, 0.6)'
            : 'rgba(255,255,255,0.1)',
          color: 'white',
          boxShadow: formState.usernameguestattendingrehearsal === false || formState.usernameguestattendingrehearsal === 'false'
            ? '0 0 8px rgba(255,0,0,0.4)'
            : 'none',
          transition: 'all 0.2s ease',
        }}
    ...
    <div
      style={{
        ...
        background: formState.usernameguestattendingrehearsal === true || formState.usernameguestattendingrehearsal === 'true'
          ? 'rgba(0, 180, 0, 0.6)'
          : formState.usernameguestattendingrehearsal === false || formState.usernameguestattendingrehearsal === 'false'
          ? 'rgba(180, 0, 0, 0.6)'
          : 'rgba(255, 0, 0, 0.3)',
        color: 'white',
        boxShadow: formState.usernameguestattendingrehearsal === true || formState.usernameguestattendingrehearsal === 'true'
    ...
    >
      <h2 style={{ margin: 0 }}>
        {formState.usernameguestattendingrehearsal === true || formState.usernameguestattendingrehearsal === 'true' ? 'Attending' :
         formState.usernameguestattendingrehearsal === false || formState.usernameguestattendingrehearsal === 'false' ? 'Not Attending' :
         'Please note attendance'}
      </h2>
    </div>
  )}
...
>
  ...
  style={{ 
    ...
    >We cannot accommodate additional guests or children.</h2>
       <h2 
  style={{ 
    margin: 0,
    justifyContent: 'center', 
           ...
           <Card
                  ...
                  >
                    <div>
                      ...
                      >
                        Best Email contact for wedding related updates
                      </h2>
                    </div>
                  </div>
               ...
               <div style={{
                ...
                borderRadius: '30px',
                border: '1px solid rgba(255,255,255,0.3)',
                background: formState.email ? 'rgba(255,255,255,0.1)' : 'rgba(180, 0, 0, 0.3)',
                color: 'white',
                boxShadow: formState.email ? 'none' : '0 0 8px rgba(255,0,0,0.3)',
                // transition: 'all 0.2s ease',
              }}>
                <span style={{ margin: 0 }}>
                  {formState.email ? formState.email : "Please enter email"}
                </span>
              </div>
                    </>
                )}
              ...
              <Card 
                  ...
                  >
                    <div>
                      ...
                      >
                        Dietary Restrictions or Food Allergies (optional)
                      </h2>
                    </div>
                  </div>
                ...
                borderRadius: '30px',
                border: '1px solid rgba(255,255,255,0.3)',
                background: formState.dietary ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.1)',
                color: 'white',
                boxShadow: formState.dietary ? 'none' : '0 0 8px rgba(255,0,0,0.3)',
                transition: 'all 0.2s ease',
              }}
                  >
                    {formState && formState.dietary ? formState.dietary : "No dietary restrictions or allergies"}
                  </span>
